...
Option | Description | Required
 -- | -- | --
| `language` | The language ([BCP-47](https://tools.ietf.org/html/bcp47) format) for the recording you're transcribing. This currently supports the same languages as Automatic Speech Recording, and a list is available [here](/voice/voice-api/guides/asr#language). | No |
